...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate (APR) for the savings account (as a percentage): "))
    ...
    cd_interest = float(input("Enter the annual interest rate (APR) for the CD account (as a percentage): "))
